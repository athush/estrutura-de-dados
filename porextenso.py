...
while(i < tam):
    ...
    if resto == 0:
        if conjuntos == 5:
            if (i == 0 and num[i] == '1') or (num[i] == '1' and num[i-1] == '0' and num[i-2] == '0'):
                extenso.append('Trilhão')
            else:
                extenso.append('Trilhões')
        elif conjuntos == 4:
            if (i == 0 and num[i] == '1') or (num[i] == '1' and num[i-1] == '0' and num[i-2] == '0'):
                extenso.append('Bilhão')
            else:
                extenso.append('Bilhões')
        elif conjuntos == 3:
            if (i == 0 and num[i] == '1') or (num[i] == '1' and num[i-1] == '0' and num[i-2] == '0'):
                extenso.append('Milhão')
            else:
                extenso.append('Milhões')
        elif conjuntos == 2 or conjuntos == 1:
            if (i == 0 and num[i] == '1') or (num[i] == '1' and num[i-1] == '0' and num[i-2] == '0'):
                extenso.pop()
            extenso.append('Mil')
        conjuntos-=1
